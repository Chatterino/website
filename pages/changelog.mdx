...
- You can now disable the reduced opacity for historical messages. <Credit author="fourtf" helper="Mm2PL" prs="6121" inline />
- Chatterino now supports emojis from Unicode 16.0. <Credit author="Nerixyz" prs="6155" inline />
...
### Settings {#2.5.4-settings}

<div className="changelog-entry">

- Filters, nicknames, and commands are now searchable from the top bar.
  <Credit author="apa420" helper="nerixyz" prs="5886, 5890, 5891" inline />
- Added a new hotkey action available for opening the account selector.
  <Credit author="teknsl" prs="6192" inline />
...
If you run an image host, consider providing this configuration format for Chatterino users.
...
- plugins would make an HTPT request from a timeout handler
...
- You can now disable the "double-click tab to rename" behaviour. <Credit author="jupjohn" pr="6163, 6184" />
...
- Fixed an issue where eventsub subscriptions might fail after changing user.
  <Credit author="pajlada" prs="6348" inline />

- Fixed eventsub message delete notifications not being affected by "Show
  deletions of single messages". <Credit author="Mm2PL" prs="6233" inline />
...
- Fixed the emote popup erroneously logging messages to the `Other` directory.
  <Credit author="pajlada" prs="6165" inline />

- Fixed message contents being cleared when using the close button for
  replies. <Credit author="pajlada" prs="6145" inline />

- Fixed missing BetterTTV live updates of emotes. <Credit author="iProdidgy"
  helper="Nerixyz" prs="6132" inline />

- Fixed scrolling now working on inputs in the settings. <Credit
  author="Nerixyz" prs="6128" inline />
