...
![overlay-window](./changelog/2.5.2/overlay-window.png)
...
![message-effect](./changelog/2.5.2/message-effect.png)

<br />
![gigantic-emote](./changelog/2.5.2/gigantic-emote.png)

<br />

Messages from Shared Chats now indicate which channel it was sent in.

![shared-chat](./changelog/2.5.2/shared-chat.png)
...
![streamer mode
enabled](./changelog/2.5.2/automod-blocked-term-streamer-mode-enabled.png)

![streamer mode
disabled](./changelog/2.5.2/automod-blocked-term-streamer-mode-disabled.png)
...
![in-settings](./changelog/2.5.2/moderation-button-settings.png)

In chat:

![in-chat](./changelog/2.5.2/moderation-button-in-chat.png)

After clicking the moderation icon:

![after-action](./changelog/2.5.2/moderation-button-after-click.png)
...
![user-card-pronouns](./changelog/2.5.2/user-card-pronouns.png)
