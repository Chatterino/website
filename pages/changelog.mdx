...
<p class="my-4">
  One other notable change is that the LuaLS meta files moved from
  `docs/plugin-meta.lua` to
  [`docs/lua-meta/globals.lua`](https://github.com/Chatterino/chatterino2/blob/master/docs/lua-meta/globals.lua)
  because of the new JSON module, which has a separate meta file.
</p>
