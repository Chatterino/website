...
Have you questions about plugins? Ask in our <a href={discord}>Discord</a> or [start a new
...
### Removed beta IRC support {#2.5.2-bye-irc}

<div className="changelog-entry">

If you were one of the 6 people using the IRC capability of Chatterino2, we have decided to no longer pursue this option - at least not in the way we did here. This release completely removes the IRC support. If you had IRC splits open before, they'll be replaced with empty splits with this release.
...
- Fixed 7TV emotes messing with Qt's HTML. - Authored by @nerixyz
