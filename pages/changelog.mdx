...
We are testing a plugin system in Chatterino. If you want to test it out, you can enable it in the settings under the "Plugins" tab(?).
...
Plugins are currently able to:

- TODO: List capabilities (e.g. network requests, making messages)
