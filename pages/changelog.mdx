...
## 2.5.4 (Beta 1, Not yet released) {#2.5.4}
...
- You can now add notes for a user in the usercard by clicking on the "Add notes" button. Notes are saved globally per user.
  <Credit author="fourtf, pajlada" prs="6122, 6318" inline />
- When a user is live, the usercard will now show a red dot next to their name. Hovering over it will reveal the number of viewers.
  <Credit author="Nerixyz" prs="6383" inline />
- The "Created" and "Following since" dates now have a tooltip that shows the duration since that event.
  <Credit author="Nerixyz" helper="pajlada" prs="6384" inline />

<Figure src="./changelog/2.5.4/usercard.png" width="400">
  New usercard view
</Figure>
...
- When colon-completing emotes in chat, you can now use `:~` to filter for zero-width emotes.
  <Credit author="droidicus" helper="pajlada, Nerixyz" prs="6362" inline />
- Chatterino now saves the emotes from third party providers and loads these if they fail to load upon restarting the app.
  <Credit
    author="occluder"
    helper="pajlada, Mm2PL, Nerixyz"
    prs="6125, 6229"
    inline
  />
- You can now disable the reduced opacity for historical messages.
  <Credit author="fourtf" helper="Mm2PL" prs="6121" inline />
- The paused indicator is now more visible and easier to notice.
  <Credit
    author="jacob-thompson"
    helper="pajlada, Nerixyz, iProdigy"
    prs="6123"
    inline
  />
- On Linux, you can now set the window background to a transparent color.
  <Credit author="apa420" prs="6137" inline />
- In addition to the existing options like opening a split, you can now open a channel in a custom player when right-clicking on a twitch.tv link.
  <Credit author="brian6932" prs="6403" inline />
- Chatterino now supports emojis from Unicode 16.0.
  <Credit author="Nerixyz, pajlada" prs="6155" inline />
- The emote and badge size can now be changed independently of Chatterino's overall scale.
  <Credit author="4rneee" helpers="pajlada" prs="6126" inline />
- In fast chats, you might not notice that your message was successfully sent. Chatterino can now pulse the text input when your messages have been received in chat.
  <Credit author="pajlada" prs="6380" inline />
...
- Through `c2.WebSocket`, plugins can now open WebSocket connections. This can be used to listen to events from third party services, for example.
  <Credit
    author="Nerixyz"
...
- Plugins can now create styled messages through `c2.Message.new()`.
  ...
  <Credit author="Nerixyz" helper="Mm2PL, pajlada" prs="5754" inline />
- For plugin developers, there is a new REPL (read-eval-print-loop) window similar to the browser console.
  ...
  <Credit author="Nerixyz" helper="Mm2PL, pajlada" prs="6120" inline />
...
- There's a new hotkey action available for opening the account selector.
...
The timestamp used in the logs is now customizable similar to the one used in the app itself. Additionally, logs can now use the timestamp of messages provided by Twitch instead of the local one.

<Credit author="droidicus" helper="fourtf, pajlada, nerixyz" prs="6338, 6346" />
...
- Chatterino can now export and import the image uploader configuration to/from the clipboard.
  ...
  <Credit
    ...
    inline
  />
- The JSON selector can now query arrays using their indices like `foo.0`.
  <Credit author="Nerixyz" prs="6193" inline />
...
<Credit
  author="pajlada, jupjohn, Nerixyz"
  prs="6102, 6255, 6266, 6302, 6268, 6334, 6371, 6372, 6349, 6385, 6267, 6397, 6398, 6412, 6414, 6399"
/>
