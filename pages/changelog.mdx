...
## 2.5.5 Beta 1 (Released 2026-03-01) {#2.5.5}
...
{/* TODO: Replace when 2.5.5 is released */}

- **Access and modify messages in channels**: New methods like
  [`Channel:message_snapshot`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md#channelmessage_snapshotn_items) allow plugins to retrieve all messages available in a channel. The returned
  [`c2.Message`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md#message)s can be queried (e.g. accessing individual elements). Except for their flags,
  messages in a channel can't be modified. However, you can replace messages in channels ([`Channel:replace_message`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md#channelreplace_messagemessage-replacement-hint)).
...
- **Parse and serialize JSON**: Many APIs communicate through JSON. To avoid having to include a third party library
  ...
  [`chatterino.json`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md#json-api) module that you can `require()`.
...
- **Get the current Twitch account**:
  [`c2.current_account()`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md#current_account) gives you the currently logged in account and its ID.
...
- **Display name change events**: Plugins can now get notified when the display name of a channel changes with
  [`Channel:on_display_name_changed`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md#channelon_display_name_changedcb).
...
{/* TODO: Replace tag when 2.5.5 is released */}
The LuaLS meta files moved from `docs/plugin-meta.lua` to [`docs/lua-meta/globals.lua`](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/lua-meta/globals.lua) because of the new JSON module, which has a separate meta file.
...
[here](https://github.com/Chatterino/chatterino2/blob/v2.5.5-beta.1/docs/wip-plugins.md).
...
TODO: https://github.com/Chatterino/chatterino2/pull/6766

TODO: mention dependency changes? e.g. minimum qt version etc
