...
## 2.5.5 Beta 1 (Released 2026-02-??) {#2.5.5}
...
{/* TODO: Replace commit hashes with tag when 2.5.5 is released */}

- **Access and modify messages in channels**: New methods like
  [`Channel:message_snapshot`](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md#channelmessage_snapshotn_items) allow plugins to retrieve all messages available in a channel.
  The returned [`c2.Message`](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md#message)s can be queried (e.g. accessing individual elements). Except for their flags,
  messages in a channel can't be modified. However, you can replace messages in channels ([`Channel:replace_message`](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md#channelreplace_messagemessage-replacement-hint)).
...
- **Parse and serialize JSON**: Many APIs communicate through JSON. To avoid having to include a third party library
  every time, Chatterino now provides a built-in [`chatterino.json`](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md#json-api) module that you can `require()`.

  <Credit author="Nerixyz" helper="Mm2PL, pajlada" prs="6420, 6530" inline />

- **Get the current Twitch account**: [`c2.current_account()`](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md#current_account) gives you the currently logged in account and its ID.
...
- **Display name change events**: Plugins can now get notified when the display name of a channel changes with
  [`Channel:on_display_name_changed`](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md#channelon_display_name_changedcb).
...
{/* TODO: Replace commit hashes with tag when 2.5.5 is released */}
The LuaLS meta files moved from `docs/plugin-meta.lua` to [`docs/lua-meta/globals.lua`](https://github.com/Chatterino/chatterino2/blob/master/docs/lua-meta/globals.lua) because of the new JSON module, which has a separate meta file.
...
[here](https://github.com/Chatterino/chatterino2/blob/09a6c3fd7a19fe0178a0e0060c848febab3ae294/docs/wip-plugins.md).
...
{/* TODO: Add list of all new contributors here and thank them */}
