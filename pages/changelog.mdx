...
![img](https://i.pajlada.se/da27C.png)
...
![message-effects](https://i.pajlada.se/RZHpw.png)

![gigantic-emote](https://i.pajlada.se/owWvk.png)

<br />

Messages from Shared Chats now indicate which channel it was sent in.

![shared-chat](https://i.pajlada.se/tMdMx.png)
...
![in-settings](https://i.pajlada.se/cx8xY.png)

In chat:

![in-chat](https://i.pajlada.se/qHHLi.png)

After clicking the moderation icon:

![after-action](https://i.pajlada.se/MnpCR.png)
