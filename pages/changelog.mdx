...
You can now search for your chat messages selection with a search engine of
...
/>
 ...
 - You can now right-click any tab and sort your tabs by name alphabetically. This is an action, not a setting meaning if you want to sort your tabs again, you have to click the sort action again. <Credit
  author="teknsl"
  helper="ruinivist, Nerixyz, pajlada"
  prs="6551, 6710"
  inline
/>
...
- Improved setting stability. <Credit author="pajlada, Nerixyz" prs="6620, 6662" inline />
...
- Consolidate font picking into one dialog. <Credit author="teknsl" helper="pajlada" prs="6531" inline />
...
- Fixed WebSocket connection issues with IPv6. <Credit author="pajlada, Nerixyz" prs="6631" inline />
